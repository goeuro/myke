...
* Tasks execute with a predictable environment irrespective of which folder they are invoked from. Principled bottom-up approach
...
* Command is run using `sh -exc` in Linux, and `cmd.exe /C` in Windows
